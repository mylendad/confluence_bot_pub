...
| --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ошибка 401/403 Confluence                                 | Неверный тип auth/token или нет прав на space/page.                                                                        | Проверить `CONFLUENCE_AUTH_TYPE`, `CONFLUENCE_USERNAME`, `CONFLUENCE_API_TOKEN`, доступ к странице в браузере.                              |
